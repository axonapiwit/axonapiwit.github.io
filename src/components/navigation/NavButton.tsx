...
// Define icon mapping as a reusable object
const iconMap: Record<string, JSX.Element> = {
  ...
  resume: <NotebookText className="w-full h-auto" strokeWidth={1.5} />,
};

// Function to get the correct icon
const getIcon = (icon: string): JSX.Element =>
  iconMap[icon] || <Home className="w-full h-auto" strokeWidth={1.5} />;
